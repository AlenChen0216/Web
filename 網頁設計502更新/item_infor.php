...
<?php
    if(isset($_GET['uid'])){
        ...
        if($_GET['uid']=='1001'){
            $name = '吳郭魚';
            $img = "./image/seafood/吳郭魚.jpg";
            $price = "65";
            $coupon = "滿600折60";
            $review = '90%';
            $total_amount = 10;
            $short_des = array('台灣本土養殖','世界級標準飼養','新鮮冷凍','肉質鮮美');
            $description = "jdiehf\nsdkjfhs\n";
            $critic[] = array('1','70%','AAAAAAAAAAAAAA');
            $critic[] = array('2','50%','BBBBBBBBBBBBBB');
        }else if($_GET['uid']=='1002'){
            $name = '小卷';
            $img = "./image/seafood/小卷.jpg";
            $price = "80";
            $coupon = "滿600折60";
            $review = '85%';
            $total_amount = 5;
            $short_des = array('沿海捕撈','新鮮冷凍');
            $description = "jdiehf\nsdkjfhs\n";
            $critic[] = array('12','90%','DSDF');
            $critic[] = array('23','40%','EWB');
        }
    }
?>
<script>
